        ...
        <div class="row page-titles mx-0">
            <div class="col p-md-0">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active"><a href="javascript:void(0)">Catégorie</a></li>
                </ol>
            </div>
        </div>
                ...
                <form id="fadd">
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="description" class="form-control" id="" cols="30" rows="3" maxlength="255"></textarea>
                        </div>
                        <div class="form-group">
                            <div id="rep"></div>
                        </div>
