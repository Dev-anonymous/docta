                ...
                <form id="fedit">
                    ...
                    <div class="modal-body">
                        <div class="form-group">
                            <label for="recipient-name" class="col-form-label">Prix par sec</label>
                            <input type="number" min="0.0001" step="0.0001" value="{{ $data->cout }}"
                                class="form-control" name="cout" required>
                        </div>
                        <div class="form-group">
                            <div id="rep"></div>
                        </div>
